...
function getTabFromSearch(tab: string | null): TabValue {
...
export default function Profile() {
  ...
  const [activeTab, setActiveTab] = useState<TabValue>(() => getTabFromSearch(tabFromUrl));

  useEffect(() => {
    const newTab = getTabFromSearch(tabFromUrl);
    if (newTab !== activeTab) {
      setActiveTab(newTab);
    }
            ...
            {cardsLoading ? (
              ...
              <Card>
                <CardContent className="p-8 text-center">
                  ...
                  <Button onClick={() => router.push("/home")} data-testid="button-create-first-card">
                    View Elections
                  </Button>
                </CardContent>
              </Card>
